...
calc_vg_benchmark_stats sim_mc_grch38_hg002_vgrna_k32_h${HAP_IDX}.star_fixed_rsort.bam benchmark_hsts.reheader.bam sim_mc_grch38_hg002_vgrna_k32_h${HAP_IDX}.read_origin.txt 3 null null null null > bam_eval_r1_star_sim_hg002_gen38_h${HAP_IDX}_ovl3.txt
